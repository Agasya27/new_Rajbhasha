  ...
  function renderSec3(){
    ...
    sec3.forEach((row, idx)=>{
      ...
      tr.innerHTML = `<td>${idx+1}</td>
        <td><input type="number" class="form-control" min="0" value="${row.total||0}"></td>
        <td><input type="number" class="form-control" min="0" value="${row.hi||0}"></td>
        <td><input type="number" class="form-control" min="0" value="${row.en||0}"></td>
      ...
      if (iTotal) iTotal.addEventListener('input', ()=>{ sec3[idx].total = Number(iTotal.value||0); syncSec3Hidden(); });
      if (iHi)    iHi.addEventListener('input',    ()=>{ sec3[idx].hi = Number(iHi.value||0); syncSec3Hidden(); });
      if (iEn)    iEn.addEventListener('input',    ()=>{ sec3[idx].en = Number(iEn.value||0); syncSec3Hidden(); });
